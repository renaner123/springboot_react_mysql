...
public class PersonControllerYamlTest extends AbstractIntegrationTest {
	...
	public void testCreate() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals("Nelson", persistedPerson.getFirst_name());
		assertEquals("Piquet", persistedPerson.getLast_name());
	...
	public void testUpdate() throws JsonMappingException, JsonProcessingException {
		person.setLast_name("Piquet Souto Maior");
		...
		assertEquals("Nelson", persistedPerson.getFirst_name());
		assertEquals("Piquet Souto Maior", persistedPerson.getLast_name());
		assertEquals("Brasília - DF - Brasil", persistedPerson.getAddress());
		assertEquals("Male", persistedPerson.getGender());
	}
	...
	private void mockPerson() {
		person.setFirst_name("Nelson");
		person.setLast_name("Piquet");
